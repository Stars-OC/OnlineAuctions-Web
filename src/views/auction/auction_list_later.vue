					...
					<el-row :gutter="10">
						<el-col :span="8">
							<el-radio-group v-model="radio">
								<el-radio label="1" size="large">流拍</el-radio>
								<el-radio label="2" size="large">已售出</el-radio>
								<el-radio label="2" size="large">再拍卖</el-radio>
							</el-radio-group>
						</el-col>
						...
						<el-table-column label="状态">
							<template v-slot="scope">
								...
								<el-button
									...
									type="primary"
									size="small"
									@click="toAuction(scope.row.auctionId)"
								>
									查看
								</el-button>
								<el-button v-else style="margin-left: 20px" type="primary" size="small" disabled>
									查看
								</el-button>
							</template>
						</el-table-column>
